...
- [ ] 04-02-PLAN.md — Seq2Seq and Token Classifier profiles completing all four model types

**Wave 3** *(blocked on Wave 2 completion)*

- [ ] 04-03-PLAN.md — Dynamic batching with channel-based request collection
